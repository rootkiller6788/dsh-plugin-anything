...
The gate is itself tested against single-field mutants: all sixteen rejection branches the plugin verifier
can take have a test that observes one fire and asserts its message. The `--kit` rung checks this repository
